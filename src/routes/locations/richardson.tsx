...
const SERVICES_IN_CITY = [
  ...
  },
  {
    ...
    body: "Service at your home, office, apartment lot, or job site. Mobile is the default for most Richardson jobs, not a premium add-on.",
  },
  {
...
const FAQS = [
  {
    question: "How fast can someone come out in Richardson?",
    answer:
      "Same-day mobile service is available for many Richardson addresses, depending on the vehicle, glass availability, and what time you call. Calls before mid-morning have the most flexibility for same-day scheduling. Call (214) 555-0100 and we will tell you what your specific job looks like.",
  },
  {
    question: "Do you service the Telecom Corridor and UTD area?",
    answer:
      "Yes. Telecom Corridor (75081, 75082), CityLine (75082), Canyon Creek (75080), J.J. Pearce (75081), Cottonwood Park (75081), and Heights Park (75081) are all served. Mobile setup works at corporate parking decks along US-75, the UTD campus and surrounding apartment complexes, the Eisemann Center, and residential subdivisions across both sides of US-75. Most Richardson addresses fall within standard mobile coverage.",
  },
  {
  ...
  {
    question: "Do you do same-day service in Richardson?",
    answer:
...
const DESCRIPTION =
  "Mobile auto glass service in Richardson, TX — Telecom Corridor, CityLine, Canyon Creek, J.J. Pearce. Windshield replacement and repair at your home or office. Call or text (214) 555-0100.";

export const Route = createFileRoute("/locations/richardson")({
  component: LocationPage,
  head: () =>
    buildSeo({
      title: "Auto Glass Richardson, TX | Same-Day Windshield Repair & Replacement",
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="bg-background">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 md:grid-cols-[1.1fr_0.9fr] md:gap-12 md:py-16">
          ...
          <h1 className="text-4xl font-extrabold leading-tight md:text-5xl">
            Auto Glass Richardson, TX — Same-Day Windshield Repair & Replacement
          </h1>
          <p className="mt-5 text-lg text-muted-foreground">
            Cracked or shattered windshield in Richardson? Call {PHONE} and we will connect you with a vetted local Richardson auto glass operator. Mobile service across the Telecom Corridor, CityLine, and the rest of Richardson — most jobs handled the same day, cash or insurance.
          </p>
      ...
      <section className="border-t border-border bg-secondary/30">
        <div className="mx-auto max-w-5xl px-4 py-14">
          <h2 className="text-3xl font-bold">Where in Richardson do we serve?</h2>
          <p className="mt-4 text-muted-foreground">
            Richardson sits along US-75 (Central Expressway), with the President George Bush Turnpike cutting across the north end and Belt Line Road handling east-west traffic through the older core of the city. The Telecom Corridor and CityLine corporate campuses concentrate weekday commuter traffic along US-75, and the construction along the Bush Turnpike — which has been close to nonstop for years — produces a regular supply of flying-debris damage on the highway corridors.
          </p>
          <p className="mt-4 text-muted-foreground">
            Hail season runs from March through June in North Texas, and storms tracking up US-75 can hit Richardson hard — a single supercell can damage windshields across Canyon Creek and the Telecom Corridor in one afternoon. Summer heat from June through September pushes pavement temperatures past 150°F, which is enough to turn a small chip into a full-length crack in hours. The combination keeps demand steady for both mobile chip repair and full windshield replacement, with insurance-assisted and cash-pay options both common across the Richardson market. Call {PHONE} to confirm coverage for your address.
          </p>

          <div className="mt-8 grid gap-8 md:grid-cols-3">
            <div>
              <h3 className="text-lg font-semibold">Richardson neighborhoods</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold">Richardson ZIP codes</h3>
              <ul className="mt-3 space-y-1 text-muted-foreground">
                {ZIPS.map((z) => (
                  <li key={z}>{z}</li>
                ))}
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-5xl px-4 py-14">
          <h2 className="text-3xl font-bold">
            What auto glass services do operators provide in Richardson?
          </h2>
          <p className="mt-4 text-muted-foreground">
            From a rock chip picked up on US-75 near the Telecom Corridor to a windshield shattered after a North Texas hailstorm, the Richardson operators we connect drivers with handle the full range of auto glass work. Call {PHONE} for a phone consultation, or text a photo of the damage and the vehicle year, make, and model.
          </p>
      ...
      <section className="border-t border-border bg-secondary/30">
        <div className="mx-auto max-w-3xl px-4 py-14">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground">
            <p>
              In many cases, yes. Richardson drivers carrying Texas comprehensive auto coverage often have windshield repair or replacement included, and many carriers offer a separate Auto Glass Endorsement that waives the deductible on chip repair. Coverage and deductible amounts depend on your specific policy, so it is smart to confirm with your insurer before assuming.
            </p>
            <p>
              The Richardson operators we route to regularly bill State Farm, GEICO, Progressive, Allstate, USAA, Liberty Mutual, Farmers, and Nationwide. If you would rather pay cash and skip the claim process entirely — which some Richardson drivers prefer when the deductible is close to the replacement cost — both options are quoted up front. Call {PHONE} and we will walk through what likely makes more sense for your situation.
            </p>
            <p>
      ...
      <section id="faq" className="bg-background">
        <div className="mx-auto max-w-3xl px-4 py-14">
          <h2 className="text-3xl font-bold">Richardson Auto Glass FAQ</h2>
      ...
      >
        <div className="mx-auto max-w-3xl px-4 text-center">
          <h2 className="text-2xl font-bold md:text-3xl">
            Cracked Windshield in Richardson? Call Now.
          </h2>
          <p className="mt-3 opacity-80">
            Same-day mobile service across Richardson neighborhoods. Cash or insurance options quoted up front.
          </p>
