...
export const Route = createFileRoute("/locations/irving")({
  ...
  head: () =>
    buildSeo({
      title: "Auto Glass Irving, TX | Windshield Replacement",
      description:
    ...
    <main className="min-h-screen bg-background">
      <section className="container mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold tracking-tight">
          Auto Glass Irving, TX & Windshield Specialists
        </h1>
        <p className="mt-4 text-lg text-muted-foreground">
          Mobile windshield replacement and repair in Irving — we come to your home, office, or driveway. Same-day service available.
        </p>
        <div className="mt-8">
          <a
