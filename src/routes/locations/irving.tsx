...
const SERVICES_IN_CITY = [
  ...
  },
  {
    ...
    body: "Service at your home, office, apartment lot, or job site. Mobile is the default for most Irving jobs, not a premium add-on.",
  },
  {
...
const FAQS = [
  {
    question: "How fast can someone come out in Irving?",
    answer:
      "Same-day mobile service is available for many Irving addresses, depending on the vehicle, glass availability, and what time you call. Calls before mid-morning have the most flexibility for same-day scheduling. Call (214) 555-0100 and we will tell you what your specific job looks like.",
  },
  {
    question: "Do you service Las Colinas and Valley Ranch?",
    answer:
      "Yes. Las Colinas (75038, 75039), Valley Ranch (75063), Downtown Irving (75060), MacArthur Park (75061), and Hackberry Creek (75063) are all served. Mobile setup works at Las Colinas corporate parking decks, the Toyota Music Factory area, residential subdivisions throughout Valley Ranch, and on the south side near DFW Airport. Most Irving addresses fall within standard mobile coverage.",
  },
  {
  ...
  {
    question: "Do you do same-day service in Irving?",
    answer:
  ...
  {
    question: "Are auto glass operators in Irving licensed and insured?",
    answer:
      "The Irving auto glass operators we connect drivers with carry the standard insurance and credentials expected for auto glass work in Texas. Dallas Windshield and Auto Glass Pros is a lead-routing service; the installation itself is performed by the local operator we connect you with. Operator details are confirmed before dispatch.",
  },
  {
...
const DESCRIPTION =
  "Mobile auto glass service in Irving, TX — Las Colinas, Valley Ranch, Downtown Irving, MacArthur Park. Windshield replacement and repair at your home or office. Call or text (214) 555-0100.";

export const Route = createFileRoute("/locations/irving")({
  component: LocationPage,
  head: () =>
    buildSeo({
      title: "Auto Glass Irving, TX | Same-Day Windshield Repair & Replacement",
      ...
      schema: [
        buildBreadcrumbListSchema({
          items: [
            ...
            { name: "Irving", url: "/locations/irving", position: 3 },
          ],
        }),
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="bg-background">
        <div className="mx-auto grid max-w-6xl items-start gap-10 px-4 py-10 md:grid-cols-[1.1fr_0.9fr] md:gap-12 md:py-14">
          ...
          <p className="text-xs font-semibold uppercase tracking-widest text-brand md:text-sm">
            Serving Irving, TX & DFW
          </p>
          <h1 className="mt-4 text-4xl font-extrabold leading-tight md:text-5xl">
            Auto Glass Irving, TX — Same-Day Windshield Repair & Replacement
          </h1>
          <p className="mt-5 text-lg text-muted-foreground">
            Cracked or shattered windshield in Irving? Call {PHONE} and we will connect you with a vetted local Irving auto glass operator. Mobile service across Las Colinas, Valley Ranch, and the rest of Irving — most jobs handled the same day, cash or insurance.
          </p>
      ...
      <section className="border-t border-border bg-secondary/30">
        <div className="mx-auto max-w-5xl px-4 py-14">
          <h2 className="text-3xl font-bold">Where in Irving do we serve?</h2>
          <p className="mt-4 text-muted-foreground">
            Irving sits at the intersection of I-635 (LBJ Freeway), I-35E (Stemmons), and SH-114, with the President George Bush Turnpike cutting across the north end and DFW International Airport bordering the west side. That combination — LBJ freight, airport-bound traffic on SH-114, and constant construction along the SH-114 corridor through Las Colinas — produces some of the steadiest highway-debris exposure anywhere in DFW, which is why Irving drivers tend to see chip and crack damage as a recurring rather than one-time problem.
          </p>
          <p className="mt-4 text-muted-foreground">
            Hail season runs from March through June in North Texas, and storms tracking east off I-35E can cluster damage across Las Colinas and Valley Ranch in a single afternoon. Summer heat from June through September pushes pavement temperatures past 150°F, which is enough to turn a small chip into a full-length crack in hours. The combination keeps demand steady for both mobile chip repair and full windshield replacement, with insurance-assisted and cash-pay options both common across the Irving market. Call {PHONE} to confirm coverage for your address.
          </p>

          <div className="mt-8 grid gap-8 md:grid-cols-3">
            <div>
              <h3 className="text-lg font-semibold">Irving neighborhoods</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold">Irving ZIP codes</h3>
              <ul className="mt-3 space-y-1 text-muted-foreground">
                {ZIPS.map((z) => (
                  <li key={z}>{z}</li>
                ))}
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-5xl px-4 py-14">
          <h2 className="text-3xl font-bold">
            What auto glass services do operators provide in Irving?
          </h2>
          <p className="mt-4 text-muted-foreground">
            From a rock chip picked up on SH-114 between Las Colinas and DFW Airport to a windshield shattered after a North Texas hailstorm, the Irving operators we connect drivers with handle the full range of auto glass work. Call {PHONE} for a phone consultation, or text a photo of the damage and the vehicle year, make, and model.
          </p>
      ...
      <section className="border-t border-border bg-secondary/30">
        <div className="mx-auto max-w-3xl px-4 py-14">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground">
            <p>
              In many cases, yes. Irving drivers carrying Texas comprehensive auto coverage often have windshield repair or replacement included, and many carriers offer a separate Auto Glass Endorsement that waives the deductible on chip repair. Coverage and deductible amounts depend on your specific policy, so it is smart to confirm with your insurer before assuming.
            </p>
            <p>
              The Irving operators we route to regularly bill State Farm, GEICO, Progressive, Allstate, USAA, Liberty Mutual, Farmers, and Nationwide. If you would rather pay cash and skip the claim process entirely — which some Irving drivers prefer when the deductible is close to the replacement cost — both options are quoted up front. Call {PHONE} and we will walk through what likely makes more sense for your situation.
            </p>
            <p>
      ...
      <section id="faq" className="bg-background">
        <div className="mx-auto max-w-3xl px-4 py-14">
          <h2 className="text-3xl font-bold">Irving Auto Glass FAQ</h2>
      ...
      >
        <div className="mx-auto max-w-3xl px-4 text-center">
          <h2 className="text-2xl font-bold md:text-3xl">
            Cracked Windshield in Irving? Call Now.
          </h2>
          <p className="mt-3 opacity-80">
            Same-day mobile service across Irving neighborhoods. Cash or insurance options quoted up front.
          </p>
