...
const ENTRY = cities.find((c) => c.slug === "mesquite")!;
...
const SERVICES_IN_CITY = [
  ...
  },
  {
    ...
    body: "Service at your home, office, apartment lot, or job site. Mobile is the default for most Mesquite jobs, not a premium add-on.",
  },
  {
...
const FAQS = [
  {
    question: "How fast can someone come out in Mesquite?",
    answer:
      "Same-day mobile service is available for many Mesquite addresses, depending on the vehicle, glass availability, and what time you call. Calls before mid-morning have the most flexibility for same-day scheduling. Call (214) 555-0100 and we will tell you what your specific job looks like.",
  },
  {
    question: "Do you service Town East and Downtown Mesquite?",
    answer:
      "Yes. Town East (75150), Downtown Mesquite (75149), Northwest Mesquite (75150), Skyline (75149), and Creek Crossing (75180) are all served. Mobile setup works around Town East Mall, the Mesquite Championship Rodeo, the Mesquite Arts Center, and residential subdivisions on both sides of I-635. Most Mesquite addresses fall within standard mobile coverage.",
  },
  {
  ...
  {
    question: "Do you do same-day service in Mesquite?",
    answer:
  ...
  {
    question: "Are auto glass operators in Mesquite licensed and insured?",
    answer:
      "The Mesquite auto glass operators we connect drivers with carry the standard insurance and credentials expected for auto glass work in Texas. Dallas Windshield and Auto Glass Pros is a lead-routing service; the installation itself is performed by the local operator we connect you with. Operator details are confirmed before dispatch.",
  },
  {
...
const DESCRIPTION =
  "Mobile auto glass service in Mesquite, TX — Town East, Downtown Mesquite, Northwest Mesquite, Skyline. Windshield replacement and repair at your home or office. Call or text (214) 555-0100.";

export const Route = createFileRoute("/locations/mesquite")({
  component: LocationPage,
  head: () =>
    buildSeo({
      title: "Auto Glass Mesquite, TX | Same-Day Windshield Repair & Replacement",
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="bg-background">
        <div className="mx-auto grid max-w-6xl items-start gap-10 px-4 py-10 md:grid-cols-[1.1fr_0.9fr] md:gap-12 md:py-14">
          ...
          <p className="text-xs font-semibold uppercase tracking-widest text-brand md:text-sm">
            Serving Mesquite, TX & DFW
          </p>
          <h1 className="mt-4 text-4xl font-extrabold leading-tight md:text-5xl">
            Auto Glass Mesquite, TX — Same-Day Windshield Repair & Replacement
          </h1>
          <p className="mt-5 text-lg text-muted-foreground">
            Cracked or shattered windshield in Mesquite? Call {PHONE} and we will connect you with a vetted local Mesquite auto glass operator. Mobile service across Town East, Downtown Mesquite, and the rest of Mesquite — most jobs handled the same day, cash or insurance.
          </p>
          ...
          <div id="quote" className="scroll-mt-20">
            <QuoteForm source="city:mesquite" />
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-border bg-secondary/30">
        <div className="mx-auto max-w-5xl px-4 py-14">
          <h2 className="text-3xl font-bold">Where in Mesquite do we serve?</h2>
          <p className="mt-4 text-muted-foreground">
            Mesquite sits at the intersection of I-635 (LBJ Freeway), I-30, and US-80, with Town East Boulevard handling commercial and retail traffic across the heart of the city. The combination of I-635 freight flow on the west side, I-30 commuter traffic moving east toward Rockwall, and US-80 carrying long-haul trucks toward east Texas produces some of the densest highway-debris exposure anywhere on the east side of the metroplex — the everyday reason Mesquite drivers end up needing chip or windshield work.
          </p>
          <p className="mt-4 text-muted-foreground">
            Hail season runs from March through June in North Texas, and Mesquite catches a fair share of the storms moving east across Dallas County. Summer heat from June through September pushes pavement temperatures past 150°F, which is enough to turn a small chip into a full-length crack in hours. The combination keeps demand steady for both mobile chip repair and full windshield replacement, with insurance-assisted and cash-pay options both common across the Mesquite market. Call {PHONE} to confirm coverage for your address.
          </p>

          <div className="mt-8 grid gap-8 md:grid-cols-3">
            <div>
              <h3 className="text-lg font-semibold">Mesquite neighborhoods</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold">Mesquite ZIP codes</h3>
              <ul className="mt-3 space-y-1 text-muted-foreground">
                {ZIPS.map((z) => (
                  <li key={z}>{z}</li>
                ))}
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-5xl px-4 py-14">
          <h2 className="text-3xl font-bold">
            What auto glass services do operators provide in Mesquite?
          </h2>
          <p className="mt-4 text-muted-foreground">
            From a rock chip picked up on I-635 near Town East to a windshield shattered after a North Texas hailstorm, the Mesquite operators we connect drivers with handle the full range of auto glass work. Call {PHONE} for a phone consultation, or text a photo of the damage and the vehicle year, make, and model.
          </p>
      ...
      <section id="faq" className="bg-background">
        <div className="mx-auto max-w-3xl px-4 py-14">
          <h2 className="text-3xl font-bold">Mesquite Auto Glass FAQ</h2>
      ...
      >
        <div className="mx-auto max-w-3xl px-4 text-center">
          <h2 className="text-2xl font-bold md:text-3xl">
            Cracked Windshield in Mesquite? Call Now.
          </h2>
          <p className="mt-3 opacity-80">
            Same-day mobile service across Mesquite neighborhoods. Cash or insurance options quoted up front.
          </p>
