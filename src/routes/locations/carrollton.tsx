...
const ENTRY = cities.find((c) => c.slug === "carrollton")!;
...
const HIGHWAYS = [
  ...
  "Belt Line Road",
  "Sam Rayburn Tollway (SH-121, north edge)",
];
...
const SERVICES_IN_CITY = [
  ...
  },
  {
    ...
    body: "Service at your home, office, apartment lot, or job site. Mobile is the default for most Carrollton jobs, not a premium add-on.",
  },
  {
...
const FAQS = [
  {
    question: "How fast can someone come out in Carrollton?",
    answer:
      "Same-day mobile service is available for many Carrollton addresses, depending on the vehicle, glass availability, and what time you call. Calls before mid-morning have the most flexibility for same-day scheduling. Call (214) 555-0100 and we will tell you what your specific job looks like.",
  },
  {
    question: "Do you service Old Downtown Carrollton and Hebron?",
    answer:
      "Yes. Old Downtown Carrollton (75006), Hebron (75010), Trinity Mills (75007), Indian Creek (75007), and Highland Hills (75007) are all served. Mobile setup works around the Old Downtown Carrollton Square, residential subdivisions along Hebron Parkway, and neighborhoods on both sides of the President George Bush Turnpike. Most Carrollton addresses fall within standard mobile coverage.",
  },
  {
  ...
  {
    question: "Do you do same-day service in Carrollton?",
    answer:
...
const DESCRIPTION =
  "Mobile auto glass service in Carrollton, TX — Old Downtown Carrollton, Hebron, Trinity Mills, Indian Creek. Windshield replacement and repair at your home or office. Call or text (214) 555-0100.";

export const Route = createFileRoute("/locations/carrollton")({
  component: LocationPage,
  head: () =>
    buildSeo({
      title: "Auto Glass Carrollton, TX | Same-Day Windshield Repair & Replacement",
      description: DESCRIPTION,
      canonical: "/locations/carrollton",
      ...
      schema: [
        buildBreadcrumbListSchema({
          items: [
            ...
            { name: "Carrollton", url: "/locations/carrollton", position: 3 },
          ],
        }),
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="bg-background">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 md:grid-cols-[1.1fr_0.9fr] md:gap-12 md:py-16">
          ...
          <h1 className="text-4xl font-extrabold leading-tight md:text-5xl">
            Auto Glass Carrollton, TX — Same-Day Windshield Repair & Replacement
          </h1>
          <p className="mt-5 text-lg text-muted-foreground">
            Cracked or shattered windshield in Carrollton? Call {PHONE} and we will connect you with a vetted local Carrollton auto glass operator. Mobile service across Old Downtown Carrollton, Hebron, and the rest of Carrollton — most jobs handled the same day, cash or insurance.
          </p>
      ...
      <section className="border-t border-border bg-secondary/30">
        <div className="mx-auto max-w-5xl px-4 py-14">
          <h2 className="text-3xl font-bold">Where in Carrollton do we serve?</h2>
          <p className="mt-4 text-muted-foreground">
            Carrollton sits along I-35E (Stemmons Freeway), with the President George Bush Turnpike cutting east-west across the heart of the city and Belt Line Road carrying older commuter traffic through the older neighborhoods. The Sam Rayburn Tollway (SH-121) runs just north along the Lewisville line, and the truck and freight traffic moving up I-35E toward Lewisville and Denton is one of the more reliable producers of flying-debris damage anywhere in the north metro.
          </p>
          <p className="mt-4 text-muted-foreground">
            Hail season runs from March through June in North Texas, and Carrollton sits in a hail-active corridor — storms moving east off I-35E can damage windshields across Hebron and Trinity Mills in a single afternoon. Summer heat from June through September pushes pavement temperatures past 150°F, which is enough to turn a small chip into a full-length crack in hours. The combination keeps demand steady for both mobile chip repair and full windshield replacement, with insurance-assisted and cash-pay options both common across the Carrollton market. Call {PHONE} to confirm coverage for your address.
          </p>

          <div className="mt-8 grid gap-8 md:grid-cols-3">
            <div>
              <h3 className="text-lg font-semibold">Carrollton neighborhoods</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold">Carrollton ZIP codes</h3>
              <ul className="mt-3 space-y-1 text-muted-foreground">
                {ZIPS.map((z) => (
                  <li key={z}>{z}</li>
                ))}
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-5xl px-4 py-14">
          <h2 className="text-3xl font-bold">
            What auto glass services do operators provide in Carrollton?
          </h2>
          <p className="mt-4 text-muted-foreground">
            From a rock chip picked up on I-35E near Hebron to a windshield shattered after a North Texas hailstorm, the Carrollton operators we connect drivers with handle the full range of auto glass work. Call {PHONE} for a phone consultation, or text a photo of the damage and the vehicle year, make, and model.
          </p>
      ...
      <section className="border-t border-border bg-secondary/30">
        <div className="mx-auto max-w-3xl px-4 py-14">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground">
            <p>
              In many cases, yes. Carrollton drivers carrying Texas comprehensive auto coverage often have windshield repair or replacement included, and many carriers offer a separate Auto Glass Endorsement that waives the deductible on chip repair. Coverage and deductible amounts depend on your specific policy, so it is smart to confirm with your insurer before assuming.
            </p>
            <p>
              The Carrollton operators we route to regularly bill State Farm, GEICO, Progressive, Allstate, USAA, Liberty Mutual, Farmers, and Nationwide. If you would rather pay cash and skip the claim process entirely — which some Carrollton drivers prefer when the deductible is close to the replacement cost — both options are quoted up front. Call {PHONE} and we will walk through what likely makes more sense for your situation.
            </p>
            <p>
      ...
      <section id="faq" className="bg-background">
        <div className="mx-auto max-w-3xl px-4 py-14">
          <h2 className="text-3xl font-bold">Carrollton Auto Glass FAQ</h2>
      ...
      >
        <div className="mx-auto max-w-3xl px-4 text-center">
          <h2 className="text-2xl font-bold md:text-3xl">
            Cracked Windshield in Carrollton? Call Now.
          </h2>
          <p className="mt-3 opacity-80">
            Same-day mobile service across Carrollton neighborhoods. Cash or insurance options quoted up front.
          </p>
