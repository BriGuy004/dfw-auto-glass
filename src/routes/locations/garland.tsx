...
const SERVICES_IN_CITY = [
  ...
  },
  {
    ...
    body: "Service at your home, office, apartment lot, or job site. Mobile is the default for most Garland jobs, not a premium add-on.",
  },
  {
...
const FAQS = [
  {
    question: "How fast can someone come out in Garland?",
    answer:
      "Same-day mobile service is available for many Garland addresses, depending on the vehicle, glass availability, and what time you call. Calls before mid-morning have the most flexibility for same-day scheduling. Call (214) 555-0100 and we will tell you what your specific job looks like.",
  },
  {
    question: "Do you service Firewheel and the Lake Ray Hubbard area?",
    answer:
      "Yes. Firewheel (75044), Downtown Garland (75040), Duck Creek (75041), South Garland (75043), and the Lake Ray Hubbard area (75043, 75044) are all served. Mobile setup works at Firewheel Town Center, residential subdivisions along Lake Ray Hubbard, the Garland Performing Arts Center, and neighborhoods on both sides of the President George Bush Turnpike. Most Garland addresses fall within standard mobile coverage.",
  },
  {
  ...
  {
    question: "Do you do same-day service in Garland?",
    answer:
  ...
  {
    question: "Are auto glass operators in Garland licensed and insured?",
    answer:
      "The Garland auto glass operators we connect drivers with carry the standard insurance and credentials expected for auto glass work in Texas. Dallas Windshield and Auto Glass Pros is a lead-routing service; the installation itself is performed by the local operator we connect you with. Operator details are confirmed before dispatch.",
  },
  {
...
const DESCRIPTION =
  "Mobile auto glass service in Garland, TX — Firewheel, Downtown Garland, Lake Ray Hubbard area, Duck Creek. Windshield replacement and repair at your home or office. Call or text (214) 555-0100.";

export const Route = createFileRoute("/locations/garland")({
  component: LocationPage,
  head: () =>
    buildSeo({
      title: "Auto Glass Garland, TX | Same-Day Windshield Repair & Replacement",
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="bg-background">
        <div className="mx-auto grid max-w-6xl items-start gap-10 px-4 py-10 md:grid-cols-[1.1fr_0.9fr] md:gap-12 md:py-14">
          ...
          <p className="text-xs font-semibold uppercase tracking-widest text-brand md:text-sm">
            Serving Garland, TX & DFW
          </p>
          <h1 className="mt-4 text-4xl font-extrabold leading-tight md:text-5xl">
            Auto Glass Garland, TX — Same-Day Windshield Repair & Replacement
          </h1>
          <p className="mt-5 text-lg text-muted-foreground">
            Cracked or shattered windshield in Garland? Call {PHONE} and we will connect you with a vetted local Garland auto glass operator. Mobile service across Firewheel, the Lake Ray Hubbard area, and the rest of Garland — most jobs handled the same day, cash or insurance.
          </p>
      ...
      <section className="border-t border-border bg-secondary/30">
        <div className="mx-auto max-w-5xl px-4 py-14">
          <h2 className="text-3xl font-bold">Where in Garland do we serve?</h2>
          <p className="mt-4 text-muted-foreground">
            Garland sits at the meeting point of I-635 (LBJ Freeway), I-30, and the President George Bush Turnpike, with Northwest Highway (Loop 12) feeding traffic in from western Dallas. That combination of north-side LBJ freight traffic, east-west commuter flow on I-30 heading toward Lake Ray Hubbard, and the heavy truck volume on Bush Turnpike makes for steady exposure to flying rocks and road debris — the everyday cause of the chips and cracks Garland drivers end up bringing to us.
          </p>
          <p className="mt-4 text-muted-foreground">
            Hail season runs from March through June in North Texas, and Garland sits in one of the more active hail corridors east of Dallas — a single supercell rolling in off I-30 can take out windshields across Firewheel and the Lake Ray Hubbard neighborhoods in a single afternoon. Summer heat from June through September pushes pavement temperatures past 150°F, which is enough to turn a small chip into a full-length crack in hours. The combination keeps demand steady for both mobile chip repair and full windshield replacement, with insurance-assisted and cash-pay options both common across the Garland market. Call {PHONE} to confirm coverage for your address.
          </p>

          <div className="mt-8 grid gap-8 md:grid-cols-3">
            <div>
              <h3 className="text-lg font-semibold">Garland neighborhoods</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold">Garland ZIP codes</h3>
              <ul className="mt-3 space-y-1 text-muted-foreground">
                {ZIPS.map((z) => (
                  <li key={z}>{z}</li>
                ))}
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-5xl px-4 py-14">
          <h2 className="text-3xl font-bold">
            What auto glass services do operators provide in Garland?
          </h2>
          <p className="mt-4 text-muted-foreground">
            From a rock chip picked up on I-635 near Firewheel to a windshield shattered after a North Texas hailstorm rolling in off Lake Ray Hubbard, the Garland operators we connect drivers with handle the full range of auto glass work. Call {PHONE} for a phone consultation, or text a photo of the damage and the vehicle year, make, and model.
          </p>
      ...
      <section className="border-t border-border bg-secondary/30">
        <div className="mx-auto max-w-3xl px-4 py-14">
          ...
          <div className="mt-4 space-y-4 text-muted-foreground">
            <p>
              In many cases, yes. Garland drivers carrying Texas comprehensive auto coverage often have windshield repair or replacement included, and many carriers offer a separate Auto Glass Endorsement that waives the deductible on chip repair. Coverage and deductible amounts depend on your specific policy, so it is smart to confirm with your insurer before assuming.
            </p>
            <p>
              The Garland operators we route to regularly bill State Farm, GEICO, Progressive, Allstate, USAA, Liberty Mutual, Farmers, and Nationwide. If you would rather pay cash and skip the claim process entirely — which some Garland drivers prefer when the deductible is close to the replacement cost — both options are quoted up front. Call {PHONE} and we will walk through what likely makes more sense for your situation.
            </p>
            <p>
      ...
      <section id="faq" className="bg-background">
        <div className="mx-auto max-w-3xl px-4 py-14">
          <h2 className="text-3xl font-bold">Garland Auto Glass FAQ</h2>
      ...
      >
        <div className="mx-auto max-w-3xl px-4 text-center">
          <h2 className="text-2xl font-bold md:text-3xl">
            Cracked Windshield in Garland? Call Now.
          </h2>
          <p className="mt-3 opacity-80">
            Same-day mobile service across Garland neighborhoods. Cash or insurance options quoted up front.
          </p>
